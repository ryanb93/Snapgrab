    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        if (FinderService.access$1(_fld0))
        {
    ...
    // Unreferenced inner class com/ryanburke/snapgrab/FinderService$1

/* anonymous class */
    class FinderService._cls1
        implements Runnable
    {
...
_L3:
            ...
            FinderService.access$4(FinderService.this).post(new FinderService._cls1._cls1());
_L2:
            Thread.sleep(1000L);
_L7:
            this;
